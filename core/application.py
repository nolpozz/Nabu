...
class TutorApplication:
    ...
    def _initialize_ui(self):
        ...
        self.main_container = self.theme.create_styled_frame(self.root)
        self.main_container.grid(row=0, column=0, sticky='nsew', padx=0, pady=0)
        self.main_container.grid_columnconfigure(0, weight=1)
        self.main_container.grid_rowconfigure(0, weight=1)
        
        # Initialize UI frames
        self.logger.info("Creating dashboard frame...")
    ...
    def _show_conversation(self, data: dict = None):
        ...
        # Show conversation
        self.current_frame = self.conversation_frame
    ...
    def _on_audio_started(self, data: dict = None):
        ...
        if self.current_frame == self.conversation_frame:
